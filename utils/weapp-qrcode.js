...
!(function (t, e) {
  ...
  var t = Object.prototype.hasOwnProperty,
    ...
    a = function (t, e) {
      r && '__proto__' === e.name
        ? r(t, e.name, { enumerable: !0, configurable: !0, value: e.newValue, writable: !0 })
        : (t[e.name] = e.newValue)
    },
    u = function (e, r) {
      if ('__proto__' === r) {
  ...
  ;((h.prototype = {
    ...
    (l.prototype = {
      ...
      make: function () {
        if (this.typeNumber < 1) {
          ...
          for (t = 1; t < 40; t++) {
            for (
              var e = _.getRSBlocks(t, this.errorCorrectLevel), r = new D(), o = 0, n = 0;
              n < e.length;
              n++
            )
              o += e[n].dataCount
      ...
      setupPositionAdjustPattern: function () {
        for (var t = w.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
      ...
      setupTypeInfo: function (t, e) {
        for (
          var r = (this.errorCorrectLevel << 3) | e, o = w.getBCHTypeInfo(r), n = 0;
          n < 15;
          n++
        ) {
          var i = !t && 1 == ((o >> n) & 1)
      ...
      mapData: function (t, e) {
        for (
          var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1;
          a > 0;
          a -= 2
        )
          for (6 == a && a--; ; ) {
    ...
    (l.createData = function (t, e, r) {
      ...
      for (n.getLengthInBits() + 4 <= 8 * u && n.put(0, 4); n.getLengthInBits() % 8 != 0; )
        n.putBit(!1)
      for (; !(n.getLengthInBits() >= 8 * u || (n.put(l.PAD0, 8), n.getLengthInBits() >= 8 * u)); )
        n.put(l.PAD1, 8)
      return l.createBytes(n, o)
    }),
    (l.createBytes = function (t, e) {
      for (
        var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), u = 0;
        u < e.length;
        u++
      ) {
        var s = e[u].dataCount,
  ...
  for (
    var f = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
      g = { L: 1, M: 0, Q: 3, H: 2 },
      c = 0,
      d = 1,
      m = 2,
  ...
  for (E = 8; E < 256; E++)
    y.EXP_TABLE[E] =
      y.EXP_TABLE[E - 4] ^ y.EXP_TABLE[E - 5] ^ y.EXP_TABLE[E - 6] ^ y.EXP_TABLE[E - 8]
  ...
  return (
    (A.prototype = {
      ...
      mod: function (t) {
        ...
        for (
          var e = y.glog(this.get(0)) - y.glog(t.get(0)), r = new Array(this.getLength()), o = 0;
          o < this.getLength();
          o++
        )
          r[o] = this.get(o)
    ...
    (_.getRSBlocks = function (t, e) {
      ...
      for (var o = r.length / 3, n = new Array(), i = 0; i < o; i++)
        for (var a = r[3 * i + 0], u = r[3 * i + 1], s = r[3 * i + 2], h = 0; h < a; h++)
          n.push(new _(u, s))
      return n
    }),
          ...
          ? (function () {
              ...
              ;(r.addData(
                ...
                (e = t.ctx
                  ? t.ctx
                  : t._this
                    ? wx.createCanvasContext && wx.createCanvasContext(t.canvasId, t._this)
                    : wx.createCanvasContext && wx.createCanvasContext(t.canvasId)))
              for (
                var o = t.width / r.getModuleCount(), n = t.height / r.getModuleCount(), i = 0;
                i < r.getModuleCount();
                i++
              )
